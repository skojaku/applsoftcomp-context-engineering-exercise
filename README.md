...
1. [Setup](docs/setup.md) - connect your API key and install dependencies
2. [Demo](docs/demo.md) - run the example skills to understand the patterns
3. [Your Task](docs/task.md) - build your own skill
